#ifndef _MSP_STM32F051_H_
#define _MSP_STM32F051_H_
...
#define BT_RESET_GPIO_CLK_ENABLE()  __GPIOB_CLK_ENABLE()
#define BT_RESET_GPIO_CLK_DISABLE() __GPIOB_CLK_DISABLE()
